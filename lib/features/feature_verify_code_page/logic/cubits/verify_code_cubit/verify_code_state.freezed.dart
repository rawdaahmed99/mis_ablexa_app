...
class _$InitialImpl<T> implements _Initial<T> {
  ...
  @override
  String toString() {
    return 'VerifyCodeState<$T>.initial()';
  }
...
abstract class _Initial<T> implements VerifyCodeState<T> {
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'VerifyCodeState<$T>.loading()';
  }
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'VerifyCodeState<$T>.success(data: $data)';
  }
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'VerifyCodeState<$T>.error(error: $error)';
  }
